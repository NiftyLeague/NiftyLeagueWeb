  ...
  <Layout classes={{ root: 'legal-pg' }}>
    <Container style={{ textAlign: 'left', padding: '40px', marginTop: '5%' }}>
      ...
      <p>
        ...
        disagree with any part of these Terms and Conditions, Disclaimer, or Privacy Policy then You may not access our
        Application.
      </p>
      <p>
      ...
      <p>
        ...
        the Apps (collectively, the &quot;Content&quot;) and trademarks, service marks and logos contained therein (the
        &quot;Marks&quot;) are owned, controlled by us or licensed to us. Except as expressly provided in these Terms of
        Use, no part of the Site, the App as well as the Smart Contract and no Content or Marks may be copied,
        reproduced, aggregated, republished, uploaded, posted, publicly displayed, encoded, translated, transmitted,
        distributed, sold, licensed, or otherwise exploited for any commercial purpose whatsoever, without our prior
      ...
      <p>
        ...
        that only the actual owner can display the Art; or (iii) as part of a third party website or application that
      ...
      <ol>
        ...
        <li>
          The artwork must clearly state &quot;Nifty League Fanart&quot;, link to https://www.niftyleague.com, and link
          directly to the NFT-Token that is being used for inspiration.
        </li>
        <li>
      ...
      <ol type="A">
        ...
        <li>NFTs compete with other digital assets, and this competition may negatively impact the price of an NFT.</li>
        <li>
      ...
      <p>
        ...
        prohibited. Use of third-party programs, for example, cheat or bot engines, and applications in conjunction with
        our app is strictly prohibited.
      </p>
      <h3>Disclaimer</h3>
      <p>
        ...
        the warnings and expectations outlined in our <Link href="/disclaimer">Disclaimer</Link>.
      </p>
      <h3>Governing Law</h3>
      <p>
      ...
      <p>
        ...
        (&quot;AAA&quot;) and, where appropriate, the AAA&apos;s Supplementary Procedures for Consumer-Related Disputes
        (&quot;AAA Consumer Rules&quot;), both of which are available at the AAA website www.adr.org. Your arbitration
        fees and Your share of arbitration compensation shall be governed by the AAA Consumer Rules and, where
        appropriate, limited by the AAA Consumer Rules. If such costs are determined by the arbitrator to be excessive,
        we will supplement the arbitration fees and expenses. Except where otherwise required by the applicable AA rules
        or applicable law, the arbitration will take place in the United States. Except as otherwise provided herein,
        the Parties may litigate in court to compel arbitration, stay proceedings pending arbitration, or to confirm,
        modify, vacate, or enter judgement on the award entered by the arbitrator.
      </p>
      <p>
      ...
      <p>
        ...
        You of any changes by updating the &quot;Last Updated&quot; date of these Terms of Use, and You waive any right
        to receive specific notice of each such change. It is Your responsibility to periodically review these Terms of
        Use to stay informed of updates. You will be subject to and will be deemed to have been made aware of and to
        have accepted, the changes in any revised Terms of Use by Your continued use of the Site, the App, and the Smart
