...
import { HOME_DEGEN_LIST } from '@/constants/degens';
import { SPONSORS_LIST } from '@/constants/sponsors';
...
const Home: NextPage = () => {
  ...
  return (
    <Layout classes={{ root: 'home-pg' }}>
        ...
        <div className="d-flex flex-column align-items-center text-center my-auto py-3 pt-md-5 home-content">
          ...
          <div className="d-flex align-items-center mt-3 mb-5 social-icons">
            ...
            <a className="pe-3" href="https://www.twitch.tv/niftyleagueofficial" target="_blank" rel="noreferrer">
              <svg width="28" height="24" viewBox="0 0 54 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M4.09745 0L0.445312 9.73933V48.692H13.8302V56H21.1379L28.4382 48.692H39.3918L53.9996 34.0894V0H4.09745ZM8.9631 4.86659H49.1319V31.6497L40.6094 40.1727H27.2225L19.9242 47.4706V40.1727H8.9631V4.86659ZM22.3534 29.2181H27.2224V14.6111H22.3534V29.2181ZM35.7413 29.2181H40.6094V14.6111H35.7413V29.2181Z"
                  fill="white"
                />
              </svg>
            </a>
          ...
          <div className="row m-0 p-0 position-relative">
            ...
            <div className="col-md-6">
              ...
              <MDBAccordion flush className="league-special-accordion" initialActive={1}>
                <MDBAccordionItem collapseId={1} headerTitle="Games">
                ...
                <MDBAccordionItem collapseId={2} headerTitle="DEGEN Rentals">
                ...
                <MDBAccordionItem collapseId={3} headerTitle="Play-and-earn">
      ...
      <Sponsors sponsors={SPONSORS_LIST} />
      ...
      <div className="container" style={{ maxWidth: '100%', background: '#191B1F' }}>
        <div className="row m-0 p-0 position-relative nifty-league-browse py-sm-5" style={{ minHeight: 900 }}>
          <div className="row m-0 p-0 position-relative py-5" style={{ marginBottom: 559 }}>
            ...
            >
              <Carousel mobileItems={2}>{HOME_DEGEN_LIST.map(renderDegen)}</Carousel>
            </section>
          </div>
          <div
          ...
          >
            ...
            <a href="https://opensea.io/collection/niftydegen" target="_blank" rel="noreferrer">
              <button className="btn theme-btn-aqua w-auto mt-3 mt-sm-0">
                ...
                <svg width="24" height="21" viewBox="0 0 27 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
        ...
        <div className="position-absolute text-center  d-flex align-items-center flex-column mt-5 pt-sm-5">
          ...
          <a href="https://discord.gg/niftyleague" target="_blank" rel="noreferrer">
            <button className="btn theme-btn-aqua w-auto bg-black my-3 discord-btn">
              ...
              <svg width="30" height="21" viewBox="0 0 33 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
