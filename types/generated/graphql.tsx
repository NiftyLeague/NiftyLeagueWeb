...
export enum MediaItemSizeEnum {
  /** MediaItem with the featured-image size */
  FeaturedImage = 'FEATURED_IMAGE',
  /** MediaItem with the front-about size */
  FrontAbout = 'FRONT_ABOUT',
  ...
  /** MediaItem with the header-image size */
  ...
  /** MediaItem with the portfolio size */
  Portfolio = 'PORTFOLIO',
...
/** The template assigned to the node */
export type Template_Landing = ContentTemplate & {
  __typename?: 'Template_Landing';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']>;
};
...
export type UpdateSettingsInput = {
  ...
  genesisBlocksGlobalSettingsSettingsGenesisBlocksMailchimpApiKey?: InputMaybe<Scalars['String']>;
  /** Blog pages show at most. */
