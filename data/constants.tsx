...
export const SOCIAL_LINKS = [
  {
    ...
    image: '/img/socialIcons/twitter.svg',
  },
  {
    name: 'Discord',
    description: 'Nifty League Discord',
    link: 'https://discord.gg/niftyleague',
    image: '/img/socialIcons/discord.svg',
  },
  {
    name: 'Tiktok',
    description: 'Nifty League Tiktok',
    link: 'https://www.tiktok.com/@niftyleague',
    image: '/img/socialIcons/tiktok.svg',
  },
  {
    name: 'Reddit',
    description: 'Nifty League Reddit',
    link: 'https://www.reddit.com/r/niftyleague/',
    image: '/img/socialIcons/reddit.svg',
  },
  {
    name: 'Linkedin',
    description: 'Nifty League Linkedin',
    link: 'https://www.linkedin.com/company/niftyleague/',
    image: '/img/socialIcons/linkedin.svg',
  },
  {
    name: 'Medium',
    description: 'Nifty League Medium',
    link: 'https://niftyleague.medium.com/',
    image: '/img/socialIcons/medium.svg',
  },
  {
    name: 'Facebook',
    description: 'Nifty League Medium',
    link: 'https://facebook.com/TheNiftyLeague/',
    image: '/img/socialIcons/facebook.svg',
  },
  {
    name: 'Instagram',
    description: 'Nifty League Instagram',
    link: 'https://www.instagram.com/NiftyLeague',
    image: '/img/socialIcons/instagram.svg',
  },
];
