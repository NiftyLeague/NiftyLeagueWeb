  ...
  <Layout classes={{ root: 'legal-pg' }}>
    <Container style={{ textAlign: 'left', padding: '40px', marginTop: '5%' }}>
      ...
      <p>
        ...
        in this Privacy Policy have the same meanings as in our <Link href="/terms-of-service">Terms and Conditions</Link>
        .
      </p>
      ...
      <p>If you do not use (log in to) the service for two years all of your personal data will be deleted.</p>
      ...
      <ol>
        ...
        <p>
          This Usage Data may include information such as your computer's Internet Protocol address (i.e. IP address),
        ...
        <p>
          ...
          device's operating system, the type of mobile Internet browser you use, unique device identifiers and other
          diagnostic data.
        </p>
        <li>
      ...
      <p>We may use third-party Service Providers to monitor and analyze the use of our Service for analytics.</p>
