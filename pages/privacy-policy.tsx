  ...
  <Layout classes={{ root: 'legal-pg' }}>
    <Container style={{ textAlign: 'left', padding: '40px', marginTop: '5%' }}>
      ...
      <p>
        ...
        our <Link href="/terms-of-service">Terms and Conditions</Link>.
      </p>
      <h3>Information Collection and Use</h3>
      <p>
        We reserve the right to collect several different types of information
        for various purposes to provide and improve our Service to you.
      </p>
      <p>
        If you do not use (log in to) the service for two years all of your
      ...
      <ol>
        ...
        <p>
          ...
          device, your mobile device&apos;s operating system, the type of mobile
      ...
      <p>
        Nifty League will take all steps reasonably necessary to ensure that
      ...
      <p>
        Nifty League may disclose your Personal Data in the good faith belief
        that such action is necessary:
      </p>
      <p>
        To comply with a legal obligation, to protect and defend the rights or
        property of the Nifty League, to prevent or investigate possible
      ...
      <p>
        ...
        via email at{' '}
        <a href="mailto: team@niftyleague.com">team@niftyleague.com</a> or reach
        out to one of the members of our team on{' '}
        <a
          target="_blank"
          rel="noopener noreferrer"
          href="https://discord.gg/niftyleague"
