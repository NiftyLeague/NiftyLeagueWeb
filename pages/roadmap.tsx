            ...
            <section id="cd-timeline" className="cd-container">
              <div className="cd-timeline-block fade-in">
                ...
                <div className="cd-timeline-content">
                  ...
                  <p className="mb-0">
                    ...
                    process was a one-of-a-kind spectacle that allowed minters the ability to design their own DEGEN
                    using Satoshi&apos;s{' '}
                    <strong>
              ...
              <div className="cd-timeline-block fade-in">
                ...
                <div className="cd-timeline-content">
                  ...
                  <p className="mb-0">
                    Considering browser limitations with our previous WebGL build, we made a point to focus our
                    immediate efforts on creating a launcher to house all of our games and include Discord integrations.
                    Now that memory limits are not a concern we are free to introduce additional animations, movesets,
              ...
              <div className="cd-timeline-block fade-in">
                ...
                <div className="cd-timeline-content">
                  ...
                  <p>
                    ...
                    system you&apos;ll be able to start accumulating <strong>NFTL</strong> through casual matches in
                    Nifty Smashers .
                  </p>
                  <p className="mb-0">
                    While the largest winnings go to whoever secures 1st place in a match, you&apos;ll also earn{' '}
                    <strong>NFTL</strong> through points scored as well as winning rounds. Be careful not to fall off
                    the map because there will be penalties deducted from your potential earnings!
                  </p>
                </div>
              </div>
              ...
              <div className="cd-timeline-block fade-in">
                ...
                <div className="cd-timeline-content">
                  ...
                  <p>
                    ...
                    want to scale our platform as much as possible without devaluing our genesis DEGEN tribes who stand
                  ...
                  <p className="mb-0">
                    ...
                    rental system allowing DEGEN holders to earn <strong>NFTL</strong> daily through fees. Each DEGEN
                    can be rented indefinitely but the cost for doing so will increase exponentially with each
                    additional rental. This allows the market to decide the price for each DEGEN individually while
                    spreading out the rentals across the board as some equipped with precious items, wearables, or
                    backgrounds will have a higher earn rate through NFTL multipliers.
                  </p>
                </div>
              </div>
              ...
              <div className="cd-timeline-block fade-in">
                ...
                <div className="cd-timeline-content">
                  ...
                  <p>
                    ...
                    this process is onboarding new users who may not be able to afford to own or rent a DEGEN.
                  </p>
                  <p className="mb-0">
              ...
              <div className="cd-timeline-block fade-in">
                ...
                <div className="cd-timeline-content">
                  ...
                  <p className="mb-0">
                    ...
                    to unveil our merchandise marketplace including two clothing lines. The first having a strong gaming
              ...
              <div className="cd-timeline-block fade-in">
                ...
                <div className="cd-timeline-content">
                  ...
                  <p>
                    ...
                    cool skins, weapons, consumable items, and more to enhance your DEGENS in-game. While some items may
                    be cool cosmetic additions, many will include <strong>NFTL</strong> multipliers for play-2-earn.
                  </p>
                  <p className="mb-0">
                    Items will be sold via <strong>NFTL</strong> in limited quantities. 70% of all proceeds will be
                    burned while the remainder will be sent to the DAO for its initial revenue stream.
                  </p>
                </div>
              </div>
              ...
              <div className="cd-timeline-block fade-in">
                ...
                <div className="cd-timeline-content">
                  ...
                  <p>
                    ...
                    comes with the additional benefit of having buildings already in place that you can design however
                    you see fit.
                  </p>
                  <p>
                  ...
                  <p className="mb-0">
                    ...
                    <strong>NFTL</strong> (a portion of which will be burned) so it might be worth hodling your p2e
                    earnings.
                  </p>
                </div>
              </div>
              ...
              <div className="cd-timeline-block fade-in">
                ...
                <div className="cd-timeline-content">
                  ...
                  <p className="mb-0">
                    ...
                    public offering will follow for any remaining pets. If you missed the first minting experience be
                    sure to keep this one on your calendar!
                  </p>
                </div>
              </div>
