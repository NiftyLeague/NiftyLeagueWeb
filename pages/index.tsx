              ...
              <div className="slide">
                <div className="slide-content">
                  <div className="spons-single">
                    <Image src="/img/spons2.png" layout="fixed" width="153" height="59" />
                  </div>
                </div>
              </div>
              <div className="slide">
                <div className="slide-content">
                  <div className="spons-single">
                    <Image src="/img/spons3.png" layout="fixed" width="153" height="59" />
                  </div>
                </div>
              </div>
              <div className="slide">
                <div className="slide-content">
                  <div className="spons-single">
                    <Image src="/img/spons4.png" layout="fixed" width="153" height="59" />
                  </div>
                </div>
              </div>
              <div className="slide">
                <div className="slide-content">
                  <div className="spons-single">
                    <Image src="/img/spons5.png" layout="fixed" width="153" height="59" />
                  </div>
                </div>
              </div>
              <div className="slide">
                <div className="slide-content">
                  <div className="spons-single">
                    <Image src="/img/spons6.svg" layout="fixed" width="153" height="59" />
                  </div>
                </div>
              </div>
            </Carousel>
