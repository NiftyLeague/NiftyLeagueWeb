  ...
  <Layout classes={{ root: 'legal-pg' }}>
    <Container style={{ textAlign: 'left', padding: '40px', marginTop: '5%' }}>
      ...
      <p>
        ...
        the agreement that operates between You, whether personally or on behalf
        of an entity, and the Company. These Terms and Conditions set out the
        rights and obligations of all users regarding the use of our
        Application.
      </p>
      <p>
        The Nifty League is a distributed application that is currently running
        on the Ethereum Network, using specially-developed Smart Contracts to
        enable users to own, transfer, compete, and purchase genetically-unique
        digital characters. It also intends to enable users to own and transfer
        other digital assets like plots of land or items. These assets can then
        be visualized on our Site and be used to interact with our Application
        or Online Games.
      </p>
      <p>
        In addition, each DEGEN NFT-Token accumulates a utility and governance
        token (“NFTL”). The NFTL token cannot be purchased, but it can be freely
        accumulated by holding the DEGEN NFT-Token along with contributing to
        the community. The Company does not provide or intend to provide a
        secondary market place for our NFT-Tokens or NFTL. NFTL does not
        constitute any ownership of the Company nor do we guarantee any value to
        the NFTL token in and of itself outside of the Nifty DAO, nor do we
        guarantee NFTL will be used for any platform-wide expenses outside of
        renaming characters. After the sale of an NFT-Token to You, the
        ownership of the NFT-Token, and to the connected Art, is transferred
        from the Smart Contract to the purchaser and concludes the business
        transaction between both parties.
      </p>
      <p>
        Transactions on the App are managed and confirmed via the Ethereum
        blockchain and other networks such as Arbitrum. We neither own nor
        control MetaMask, Google Chrome, the Ethereum network, Arbitrum, or any
        ...
        features of the App. We will not be liable for the acts or omissions of
        any such third parties, nor will we be liable for any damage that You
      ...
      <p>
        ...
        <Link href="/privacy-policy">Privacy Policy</Link>. If You disagree with
        any part of these Terms and Conditions, Disclaimer, or Privacy Policy
        then You may not access our Application.
      </p>
      <p>
      ...
      <p>
        Unless otherwise indicated, the Site and the Smart Contracts are our
        proprietary property and all source code, database, functionality,
        software, website design, audio, video, text, photographs, and graphics
        on the Site and the Apps (collectively, the &quot;Content&quot;) and
        trademarks, service marks and logos contained therein (the
        &quot;Marks&quot;) are owned, controlled by us or licensed to us. Except
        as expressly provided in these Terms of Use, no part of the Site, the
        App as well as the Smart Contract and no Content or Marks may be copied,
      ...
      <p>
        ...
        Contracts, You are granted a limited license to access and use the Site
        or to download or print a copy of any portion of the Content to which
        You have properly gained access solely to Your personal, non-commercial
        use. We reserve all rights not expressly granted to You in and to the
        Site, the App, the Content, and the Marks.
      </p>
      <p>
        When a User purchases a Good or platform asset, the User owns the
        underlying NFT-Token completely for as long as the User owns the
        NFT-Token. Ownership of the NFT-Token is mediated entirely by the smart
        contract and Ethereum Network (or any other applicable network): at no
        point may Nifty League seize, freeze, or otherwise modify the ownership
        of the Good.
      </p>
      <p>
        Subject to Your continued compliance with these Terms, The Company
        grants You a worldwide, non-exclusive, royalty-free license to use,
        ...
        permits the purchase and sale of Your Nifty League NFT-Tokens, provided
        that the marketplace cryptographically verifies each NFT-Token
        owner&apos;s rights to display the Art for their NFT-Token to ensure
        ...
        involvement, or participation of Your NFT-Token, provided that the
        website/application cryptographically verifies each NFT-Token
        owner&apos;s rights to display the Art for their NFT-Token to ensure
        that only the actual owner can display the Art.
      </p>
      <p>
        Provided that You own an ERC721 NFT-Token asset, You are granted a
        limited license to create fan-art and merchandise which can be used
        commercially given that You follow the terms set herein:
      </p>
      <ol>
        <li>
          Anyone creating fan-art of a NFT-Token needs to either own the
          NFT-Token they are creating fan-art from or receive permission from
          that NFT-Token&apos;s owner.
        </li>
        <li>
          Fan artwork must not use official Nifty League assets, but creating
          unique art using Nifty League NFT-Token assets as inspiration is
          acceptable.
        </li>
        <li>
          The artwork must clearly state &quot;Nifty League Fanart&quot;, link
          to https://www.niftyleague.com, and link directly to the NFT-Token
          that is being used for inspiration.
        </li>
        <li>
          A Nifty League NFT-Token can be used to generate a maximum of $10,000
          in revenue before a separate official license agreement is required to
          be discussed, agreed to and signed by both parties. The revenue can
          come from either fan-art (tokenized or physical) or merchandise
          (t-shirts, mugs, hoodies, etc).
        </li>
      </ol>
      <p>
        Creating original fan-art without monetizing it or for the sake of
        charity is acceptable without any license or ownership.
      </p>
      <p>
        Furthermore, we will not place any restrictions on using our assets or
        NFT-Token art for the creation of games generated for the Nifty League
        by community developers. Upon receipt of payment for Your development
        efforts You agree to transfer ownership and commercial rights of the
        game to our Company.
      </p>
      <h3>User Representations</h3>
      <p>
        By using the Site, the App and the Smart Contracts, You represent and
        warrant that: (i) You have the legal capacity and You agree to comply
        with these Terms of Use; (ii) You are not a minor in the jurisdiction in
        which You reside; (iii) You will not access the Site, the App and the
        Smart Contracts through automated and non-human means, whether through a
        bot, script or otherwise. This does not include building public tools
        and bots that facilitate transparency and analysis.
      </p>
      <p>
        (iv) You will not use the Site, the App, and the Smart Contracts for any
        illegal and unauthorized purpose; and (v) Your use of the Site, the App,
      ...
      <p>
        (vi) You have not been included in any trade embargoes or economic
        ...
        of Commerce. Nifty League reserves the right to choose markets and
        jurisdictions to conduct business, and may restrict or refuse, in its
        sole discretion, the provision of our Services in certain countries or
        regions.
      </p>
      ...
      <p>
        ...
        will not be asked to provide any information. The transaction occurs
        between You and the Smart Contract.
      </p>
      <p>
      ...
      <p>
        We, bound by the Smart Contract, reserve the right to refuse or cancel
        Your Order at any time for certain reasons including but not limited to:
      </p>
      <ul>
      ...
      <p>
        As transactions with a Smart Contract are digital and final goods (for
        example NFT-tokens) cannot be returned and therefore there is no Returns
        Policy.
      </p>
      <p>
        By interacting with the Smart Contract You agree that any sale is final
        and You do not have any right or possibility to cancel an Order.
      </p>
      <h4>Prices Policy</h4>
      <p>
        The Company reserves the right to revise its prices or generate new
        Smart Contracts at any time. The prices quoted are specified by the
        respective Smart Contract.
      </p>
      <h4>Payments</h4>
      <ol type="A">
        <li>
          All Goods purchased are subject to a one-time payment. A payment can
          be made through the Ethereum Blockchain only. We have no control over
          these payments or transactions, nor do we have the ability to reverse
          any transactions. With that in mind, the company will have no
          liability to You or to any third party for any claims or damages that
          may arise as a result of any transactions that You engage in via the
          App, or using the Smart Contracts, or any other transactions that You
          conduct via the Ethereum network.
        </li>
        <li>
          Ethereum requires the payment of a transaction fee (a &quot;Gas
          Fee&quot;) for every transaction that occurs on the Ethereum network.
          The Gas Fee funds the network of computers that run the decentralized
          Ethereum network. This means that You will need to pay a Gas Fee for
          each transaction that occurs via the App. The Gas Fee does not go to
          us and We have no control over its pricing.
        </li>
        <li>
          All paid prices exclude any possible duties or charges. You will be
          solely responsible to pay any and all sales, use, value-added and
          other taxes, duties, and assessments (except taxes on our net income)
          now or hereafter claimed or imposed by any governmental authority
          (collectively, &quot;Taxes&quot;) associated with Your use of the App
          (including, without limitation, any Taxes that may become payable as
          the result of Your ownership of a Nifty League NFT-Token or NFTL.
          Except for income and net-wealth taxes levied on The Company, You: (i)
          will pay or reimburse us for all national, federal, state, local or
          other taxes and assessments of any jurisdiction, including value added
          taxes and taxes as required by international tax treaties, customs or
          other import or export taxes, and amounts levied in lieu thereof based
          on charges set, services performed or payments made hereunder, as are
          now or hereafter may be imposed under the authority of any national,
      ...
      <p>
        ...
        are not owned or controlled by the Company including all articles,
      ...
      <h3>Termination</h3>
      <p>
        These Terms remain in full force and effect while You use the Site, the
        App and the Smart Contracts. We may terminate or suspend Your access
      ...
      <p>
        ...
        However, interactions between You and the public Smart Contract will be
        outside our control. In addition to terminating and suspending Your
      ...
      <ol type="A">
        <li>
          ...
          affect the value of Your NFT-Tokens, which may also be subject to
          significant price volatility. We cannot guarantee that any purchasers
          of NFT-Token will not lose money.
        </li>
        <li>
          You are solely responsible for determining what, if any, taxes apply
          to Your NFT-Token-related transactions. The Nifty League is not
        ...
        <li>
          ...
          Internet connection malfunctions, the risk of malicious software
          ...
          acknowledge that Nifty League will not be responsible for any
          communication failures, disruptions, errors, distortions or delays You
          may encounter while using the Ethereum network, however caused.
        </li>
        <li>
          ...
          Nifty League&apos;s platform, and therefore the potential utility
          and/or value of Nifty League NFT-Tokens.
        </li>
        <li>
          The regulatory regime governing blockchain technologies,
          cryptocurrencies, and tokens is currently uncertain, and new
          regulations and/or policies may materially adversely affect the
          development of the Nifty League, and therefore the potential utility
          and/or value of Nifty League NFT-Tokens.
        </li>
        <li>
          Upgrades to our platform or the Ethereum Network may have unintended,
          adverse effects on all Nifty League assets.
        </li>
      </ol>
      <h3>Disclaimer</h3>
      <p>
        Our Disclaimer includes important statements intended to specify or
      ...
      <h3>Governing Law</h3>
      <p>
        The laws of the United States, excluding its conflicts of law rules,
      ...
      <p>
        If a Party is unable to resolve a Dispute through informal negotiations,
        the Disputes (except those Disputes expressly excluded below) will be
        ...
        determined by the arbitrator to be excessive, we will supplement the
        arbitration fees and expenses. Except where otherwise required by the
        applicable AA rules or applicable law, the arbitration will take place
        in the United States. Except as otherwise provided herein, the Parties
      ...
      <p>
        ...
        courts located in the United States, and the Parties hereby consent to
      ...
      <p>
        ...
        to the Site, the App and the Smart Contracts be commenced more than one
        (1) year after the cause of the action arose. If this provision is found
      ...
      <h4>Exceptions to the Informal Negotiations and Arbitration</h4>
      <p>
      ...
      <p>
        ...
        our <Link href="/disclaimer">Disclaimer</Link> for more details.
      </p>
      <h3>Severability and Waiver</h3>
      <h4>Severability</h4>
      <p>
        If any provision of these Terms is held to be unenforceable or invalid,
        such provision will be amended and interpreted to accomplish the
      ...
      <p>
        ...
        other use of the Site, the App and the Smart Contracts with whom You
        connected via the Site, the App and the Smart Contracts. Notwithstanding
      ...
      <p>
        Our <Link href="/privacy-policy">Privacy Policy</Link> describes the
        ways we collect, use, store and disclose Your personal information, and
        is hereby incorporated by this reference into these Terms. You agree to
        the collection, use, storage, and disclosure of Your data in accordance
        with our Privacy Policy.
      </p>
      <h3>Changes to These Terms and Conditions</h3>
      <p>
        Supplemental terms and conditions or documents that may be posted on the
        Site, the App, and the Smart Contracts from time to time are hereby
        ...
        at any time and for any reason. We will alert You of any changes by
        ...
        Terms of Use by Your continued use of the Site, the App, and the Smart
        Contracts after the date such revised Terms of Use are posted.
      </p>
      <p>
