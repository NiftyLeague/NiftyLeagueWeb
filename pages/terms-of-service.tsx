  ...
  <Layout classes={{ root: 'legal-pg' }}>
    <Container style={{ textAlign: 'left', padding: '40px', marginTop: '5%' }}>
      ...
      <p>
        ...
        <Link href="/disclaimer">Disclaimer</Link> and <Link href="/privacy-policy">Privacy Policy</Link>. If You disagree
      ...
      <p>
        ...
        Order; and that (ii) You are not residing in a country excluded by the <Link href="/disclaimer">Disclaimer</Link>.
      </p>
      ...
      <p>
        ...
        Please read our <Link href="/disclaimer">Disclaimer</Link> for more details.
      </p>
      ...
      <p>
        Our <Link href="/privacy-policy">Privacy Policy</Link> describes the ways we collect, use, store and disclose Your
