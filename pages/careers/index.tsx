  ...
  return (
    <Layout classes={{ root: 'com-pg' }}>
      ...
      <div className={cn(styles.topSection, 'd-flex align-items-center justify-content-center container flex-wrap')}>
        <AnimatedWrapper>
          <div className={cn(styles.imageContainer, 'animated-fade-start animated-fade transition-delay-medium')}>
            <Image
        ...
        <div className={styles.description}>
          ...
          <AnimatedWrapper>
            <p className="animated-header-text animated-header-text-start transition-delay-small">
              ...
              what we do. You will have a large amount of ownership and work directly with the co-founders and
